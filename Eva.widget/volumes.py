...
class RevealVolumes:
    ...
    def and_save(self):
        ...
        if volumes:
            self._write_volumes_to_file(volumes, BACKUP_FILE)

    def and_list(self, console:bool=True) -> list:
        ...
        try:
            ...
            if volumes and console:
                [print(vol) for vol in volumes]
            return volumes
    ...
    def _write_volumes_to_file(self, volumes: list, file_path: str):
